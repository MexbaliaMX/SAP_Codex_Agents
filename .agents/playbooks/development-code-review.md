...
3. Add role playbooks when useful:
   - `.agents/subagents/sap-cap-project-architect.md`
   - `.agents/subagents/sap-fiori-app-advisor.md`
   - `.agents/subagents/sap-ui5-code-quality-advisor.md`
   - `.agents/subagents/sap-sqlscript-analyzer.md`
   - `.agents/subagents/sap-hana-database-advisor.md`
   - `.agents/subagents/sap-api-style-reviewer.md`
4. Use `.agents/templates/ui5-quality-review.md` for UI5 reviews or `.agents/templates/technical-readiness-review.md` for broader technical reviews.
