...
2. Add `.agents/subagents/sap-integration-flow-advisor.md` for advisory review shape.
...
6. Use `.agents/templates/integration-transport-readiness.md` for the output.
