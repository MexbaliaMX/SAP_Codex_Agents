...
4. Use `assets/templates/hypercare-triage-table.md` for the output.
...
1. Confirm severity rules. If absent, use the provisional P1-P4 starter from `workspace reference: sap-activate-governance.md (not bundled)` and mark it pending validation.
