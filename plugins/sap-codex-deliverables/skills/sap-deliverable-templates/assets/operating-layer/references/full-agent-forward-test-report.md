...
- `assets/operating-layer/playbooks/fit-to-standard-workshop.md`
- `assets/operating-layer/playbooks/process-diagnostic.md`
- `assets/operating-layer/playbooks/technical-readiness-review.md`
- `assets/operating-layer/playbooks/go-live-readiness.md`
- `assets/operating-layer/playbooks/hypercare-triage.md`
- `assets/operating-layer/playbooks/development-code-review.md`
- `assets/operating-layer/playbooks/integration-transport-readiness.md`
- `assets/operating-layer/output-profiles/`
- `assets/operating-layer/client-ready-samples/`
- `assets/operating-layer/automation/automation-candidates.md`
