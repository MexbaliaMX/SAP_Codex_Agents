...
| [s4hana-fiori-e2e-master-app-index.md](../deliverables/s4hana-fiori-e2e-master-app-index.md) / [CSV](../deliverables/s4hana-fiori-e2e-master-app-index.csv) | Master index | R2R, P2P/S2P, O2C/L2C | Knowledge Base Owner | Active | 2026-07-13 | Consolidated from process catalogs | Derived | Yes, after any catalog change | Depends on upstream catalogs; not independently verified | Regenerate after Plan-to-Produce |
| [s4hana-fiori-fit-to-standard-workshop-matrix.md](../deliverables/s4hana-fiori-fit-to-standard-workshop-matrix.md) / [CSV](../deliverables/s4hana-fiori-fit-to-standard-workshop-matrix.csv) | Workshop tracker | Cross-process | SAP Activate / PMO Lead | Active | 2026-07-13 | Derived from master index | Derived | Yes, after master index refresh | Owners, scope items, scripts and tenant evidence remain TBD | Use in Explore workshops |
| [s4hana-fiori-role-business-catalog-matrix.md](../deliverables/s4hana-fiori-role-business-catalog-matrix.md) / [CSV](../deliverables/s4hana-fiori-role-business-catalog-matrix.csv) | Security/access matrix | Cross-process | Security Lead | Active | 2026-07-13 | Derived from master index and fit-to-standard matrix | Derived | Yes, after master or workshop matrix refresh | Catalog assignment, launchpad spaces/pages and SoD not validated in tenant | Use for role design workshops |
| [s4hana-mexico-compliance-tracker.md](../deliverables/s4hana-mexico-compliance-tracker.md) / [CSV](../deliverables/s4hana-mexico-compliance-tracker.csv) | Mexico compliance tracker | Mexico overlay across R2R, P2P/S2P, O2C/L2C | Tax / Localization Lead | Active | 2026-07-13 | Derived from master, fit-to-standard and role/catalog matrices | Derived | Yes, before Mexico rollout or fiscal claims | Requires legal entity, DRC/eDocument, PAC/SAT, XML/PDF and tenant evidence | Validate with Tax, Finance, Logistics and Security |
| Plan-to-Produce Fiori catalog | Process app catalog | Plan-to-Produce | Manufacturing / Supply Chain Owner | Planned | TBD | Not created | Planned | Yes | Missing process catalog, master index refresh and downstream matrices | Create next using template |
...
1. Crear el catalogo **Plan-to-Produce** con la plantilla reutilizable.
